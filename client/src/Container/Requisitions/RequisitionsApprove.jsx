...
function RequisitionsApprove() {
  ...
  return (
    <Box p={6}>
      <Box mb={5}>
        <Heading size="md" color="gray.800" mb={1}>Approve Requisitions</Heading>
        <Text fontSize="sm" color="gray.500">{requisitions.length} requisition{requisitions.length !== 1 ? "s" : ""} pending your review</Text>
      </Box>
            ...
            {requisitions.length > 0 ? (
              ...
              <Tr>
                <Td colSpan={8} textAlign="center" py={16}>
                  <Text fontSize="sm" fontWeight="500" color="gray.400">No requisitions pending approval</Text>
                </Td>
              </Tr>
            )}
          </Tbody>
